...
public class OrderDao implements IOrderDao {
	...
	public Orders findProcessingOrderByUserId(int userId) {
		EntityManager em = JPAConfig.getEntityManager();
		try {
			return em.createQuery("SELECT o FROM Orders o WHERE o.user.id = :userId AND o.orderStatus = 'PROCESSING'",
					Orders.class).setParameter("userId", userId).getResultStream().findFirst().orElse(null);
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		} finally {
